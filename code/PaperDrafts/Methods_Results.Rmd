...
(ref:freqComparisonPlotB) Between-Groups Permutation *t*-test of High Frequency Features; c) Low Frequency Features d) Low Frequency-High Frequency Ratio Features
...
```{r freqComparisonPlotA, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = '(ref:freqComparisonPlotA)', fig.width=9, fig.asp=1}
df_freq_summaries %>%
  filter(str_detect(statistic, "control|episode|p.val")) %>%
  spread(key = statistic, value = value) %>%
  select(-p.val, everything()) %>%
...
```{r freqComparisonPlotB, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = '(ref:freqComparisonPlotB)', fig.width=9, fig.asp=1}
df_freq_summaries %>%
  filter(str_detect(statistic, "control|episode|p.val")) %>%
  spread(key = statistic, value = value) %>%
  select(-p.val, everything()) %>%
