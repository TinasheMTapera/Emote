...
```{r missingness-tab, warning = FALSE, message = FALSE, results='asis'}
...
```{r timeComparison, warning = FALSE, message = FALSE}
...
```{r timeComparisonPlot, warning = FALSE, message = FALSE, fig.cap = '(ref:timeComparisonPlot)'}
df_time_summaries %>%
  filter(str_detect(statistic, "control|episode|p.val")) %>%
  spread(key = statistic, value = value) %>%
  select(-p.val, everything()) %>%
...
```{r freqComparison, warning = FALSE, message = FALSE}
...
```{r freqComparisonPlot, warning = FALSE, message = FALSE, fig.cap = '(ref:freqComparisonPlot)'}
...
```{r freqComparisonPlotA, warning = FALSE, message = FALSE, fig.cap = '(ref:freqComparisonPlotA)'}
...
```{r freqComparisonPlotD, warning = FALSE, message = FALSE, fig.cap = '(ref:freqComparisonPlotD)'}
...
```{r highfreq-timeseries, warning = FALSE, message = FALSE, fig.cap = '(ref:highfreq-timeseries)'}
...
```{r lowfreq-timeseries, warning = FALSE, message = FALSE, fig.cap = '(ref:lowfreq-timeseries)'}
## plot the raw data for clarity
...
Additionally, a correlation matrix is added to address how features may interact in Figures \@ref(fig:corrplot-time) and \@ref(fig:corrplot-freq).

```{r corrplot-time, warning = FALSE, message = FALSE, fig.cap = '(ref:corrplot-time)'}
...
```{r corrplot-freq, warning = FALSE, message = FALSE, fig.cap = '(ref:corrplot-freq)'}
